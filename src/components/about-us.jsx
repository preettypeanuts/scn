...
export const AboutUsSection = () => {
    return (
        <div className="relative min-h-screen md:h-screen overflow-hidden m-3 rounded-main">
            <Image
                width={1000}
                height={1000}
            ...
            <div className="absolute bottom-0 left-0 flex flex-col m-4 md:m-15 space-y-3">
                <div className="text-white space-y-2 max-w-xl p-4 md:p-5 bg-darkColor/30 rounded-main backdrop-blur-sm border border-neutral-200/20">
                    <h1 className="text-4xl sm:text-5xl md:text-7xl leading-tight md:leading-20 font-semibold text-white">
                        <span className="opacity-70">Tentang </span>
                        Perusahaan
                    </h1>
