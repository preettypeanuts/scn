...
const highlights = [
    {
        ...
        description: "Mampu menyediakan hingga 1,2 miliar mata tebu untuk memenuhi kebutuhan skala nasional, baik proyek besar maupun distribusi berkelanjutan.",
    },
    {
        icon: Map,
        useImg: true,
        ...
        description: "Didukung oleh jaringan kebun yang tersebar di berbagai wilayah Indonesia, memastikan distribusi lebih cepat dan efisien.",
    },
    {
        icon: RefreshCw,
        useImg: true,
        ...
        description: "Sistem produksi dan distribusi yang terorganisir memastikan ketersediaan pasokan yang konsisten sepanjang waktu.",
    },
    {
        icon: Users,
        useImg: false,
        ...
        description: "Didukung oleh tenaga ahli dan tim berpengalaman di bidang agrikultur dan distribusi benih tebu.",
    },
    {
        icon: Building2,
        useImg: false,
        ...
        description: "Berpengalaman dalam menangani kebutuhan proyek pemerintah maupun swasta dengan standar kualitas tinggi.",
    },
];

export const HightlightPoints = () => {
    return (
        <div className="margin pb-20">
                ...
                {highlights.map((item, index) => (
                    ...
                    >
                        ...
                        <div>
                            <item.icon
                                size={42}
                                className={`p-2 ${item.useImg
                                    ? "text-white bg-darkColor/20 rounded-full backdrop-blur-sm"
                                    : "text-mainColor"
                                    }`}
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            <h2 className={`font-medium text-lg ${item.useImg ? "text-white" : "text-mainColor"}`}>
                                {item.title}
                            </h2>
